...
Thanks for thinking about contributing. EDITH 33.0.0 and later is licensed
...
EDITH's agent loop is generic — `click`, `type_text`, `scroll`,
...
This list is not exhaustive — if you use a site that EDITH handles badly,
...
2. Open the EDITH side panel on the target site.
...
If EDITH failed on a real task, the most useful thing you can give us is
...
Unless a file says otherwise, contributions to EDITH 33.0.0 and later are
...
Open a [GitHub Discussion](https://github.com/edith-one/edith/discussions)
...
join the [EDITH Discord](https://discord.gg/cgC325ssfw) — see
