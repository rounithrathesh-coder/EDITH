<p align="center">
  <img src="assets/logo-mark.png" alt="Logo EDITH" width="92">
</p>
...
<p align="center">
  <a href="https://chromewebstore.google.com/detail/edith/ljhijonmfahplgbbacgcfnaihbjljhhb"><img src="https://img.shields.io/badge/Chrome-Installer-4285F4?style=for-the-badge&amp;logo=googlechrome&amp;logoColor=white" alt="Installer EDITH depuis le Chrome Web Store"></a>
  <a href="https://addons.mozilla.org/en-US/firefox/addon/edith/"><img src="https://img.shields.io/badge/Firefox-Installer-FF7139?style=for-the-badge&amp;logo=firefoxbrowser&amp;logoColor=white" alt="Installer EDITH depuis Firefox Browser Add-ons"></a>
  <a href="https://microsoftedge.microsoft.com/addons/detail/dfbioajafcijomhljabppcelecgdgfeo"><img src="https://img.shields.io/badge/Edge-Installer-0A84FF?style=for-the-badge&amp;logo=microsoftedge&amp;logoColor=white" alt="Installer EDITH depuis Microsoft Edge Add-ons"></a>
</p>
...
<p align="center">
  ...
  <a href="https://edith.one">Site web</a> ·
  <a href="LICENSE">GPL-3.0-or-later</a>
</p>

![EDITH lit une page, remplit un formulaire et télécharge un fichier](assets/edith-demo.gif)

EDITH est une extension de navigateur qui place un agent IA dans un panneau
...
Installez depuis le [Chrome Web Store](https://chromewebstore.google.com/detail/edith/ljhijonmfahplgbbacgcfnaihbjljhhb),
les [modules Firefox](https://addons.mozilla.org/en-US/firefox/addon/edith/)
...
sélectionnez le dossier `edith/src/chrome`.
...
Cliquez sur l'icône EDITH pour ouvrir le panneau latéral, puis tapez par
exemple :
...
**EDITH Compass 1.0** est l'option par défaut : ni clé API, ni configuration
locale.

**Les modèles locaux** ne demandent pas non plus de clé API. Pointez EDITH
...
pour le prompt système et les schémas d'outils. EDITH détecte
...
`ollama launch edith --model <model>` en préversion. Détails :
...
EDITH sépare le **niveau** du **mode**. Le niveau (`compact`, `mid`, `full`)
...
| `Escape` deux fois | Arrêter un enregistrement actif depuis EDITH ou une page du navigateur |
...
| [Export and workflow formats](docs/export-and-workflow-formats.md) | `edith-config/1`, `edith-workflow/1` (en anglais) |
...
[`edith/web-tools`](https://lmstudio.ai/edith/web-tools), pour utiliser des
...
@software{edith2026,
  author = {Sokullu, Emre},
  title = {EDITH : Agent de navigation IA open source pour discuter avec les pages},
  year = {2026},
  publisher = {GitHub},
...
EDITH 33.0.0 et les versions ultérieures sont distribués sous
