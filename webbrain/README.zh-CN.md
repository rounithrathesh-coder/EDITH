<p align="center">
  <img src="assets/logo-mark.png" alt="EDITH 标志" width="92">
</p>
...
<p align="center">
  <a href="https://chromewebstore.google.com/detail/edith/ljhijonmfahplgbbacgcfnaihbjljhhb"><img src="https://img.shields.io/badge/Chrome-Install-4285F4?style=for-the-badge&amp;logo=googlechrome&amp;logoColor=white" alt="从 Chrome 应用商店安装 EDITH"></a>
  <a href="https://addons.mozilla.org/en-US/firefox/addon/edith/"><img src="https://img.shields.io/badge/Firefox-Install-FF7139?style=for-the-badge&amp;logo=firefoxbrowser&amp;logoColor=white" alt="从 Firefox 浏览器附加组件安装 EDITH"></a>
  <a href="https://microsoftedge.microsoft.com/addons/detail/dfbioajafcijomhljabppcelecgdgfeo"><img src="https://img.shields.io/badge/Edge-Install-0A84FF?style=for-the-badge&amp;logo=microsoftedge&amp;logoColor=white" alt="从 Microsoft Edge 加载项安装 EDITH"></a>
</p>
...
<p align="center">
  ...
  <a href="https://edith.one">官网</a> ·
  <a href="LICENSE">GPL-3.0-or-later</a>
</p>

![EDITH 阅读页面、填写表单并下载文件](assets/edith-demo.gif)

EDITH 是一个浏览器扩展，在标签页旁的侧边栏中放入一个 AI 智能体。你可以就当前页面
向它提问，也可以交给它一项任务，让它自己点击、输入、导航完成。它运行在你选择的模型
上 —— 本地的 llama.cpp 或 Ollama 服务、前沿云端 API，或者完全无需配置的内置托管选项。

## 安装

从 [Chrome 应用商店](https://chromewebstore.google.com/detail/edith/ljhijonmfahplgbbacgcfnaihbjljhhb)、
[Firefox 附加组件](https://addons.mozilla.org/en-US/firefox/addon/edith/) 或
...
**加载已解压的扩展程序**，选择 `edith/src/chrome` 文件夹。
...
**EDITH Compass 1.0** 是默认选项，无需 API 密钥或本地配置。

**本地模型** 同样无需 API 密钥。将 EDITH 指向任意 OpenAI 兼容服务即可：
...
系统提示加工具 schema。EDITH 会为 llama.cpp、Ollama 和 LM Studio 自动检测真实窗口，
并在对话接近上限时自动压缩。此外还有预览版的
`ollama launch edith --model <model>` 交接。详见
...
EDITH 将**层级**与**模式**分开。层级（`compact`、`mid`、`full`）是按提供商设置的，
...
Chrome 侧边面板快捷键在 EDITH 侧边面板获得焦点时生效。
...
| `Escape` 两次 | 从 EDITH 或浏览器页面停止当前录制 |
...
| [导出与工作流格式](docs/export-and-workflow-formats.md) | `edith-config/1`、`edith-workflow/1`（英文） |
...
位于 [`edith/web-tools`](https://lmstudio.ai/edith/web-tools)，面向希望在
...
@software{edith2026,
  author = {Sokullu, Emre},
  title = {EDITH: 开源 AI 浏览器智能体，用于与网页对话},
  year = {2026},
  publisher = {GitHub},
...
EDITH 33.0.0 及更高版本采用 [GPL-3.0-or-later](LICENSE) 许可证，因为发布的
