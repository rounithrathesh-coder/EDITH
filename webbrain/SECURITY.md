...
EDITH operates with extensive browser permissions (`<all_urls>`, `debugger`, `downloads`, `tabCapture`) and drives authenticated sessions. If you discover a security vulnerability, please handle it responsibly.
...
**[Report a vulnerability →](https://github.com/edith-one/edith/security/advisories/new)**
