...
- `edith-social-card.png` — 1280×640
- `edith-social-card-300x188.png` — 300×188 thumbnail derivative, retypeset rather than downscaled
- `store-promo-1400x560.png` — 1400×560 store marquee
- `store-promo-440x280.png` — 440×280 small store tile
- `banners/edith-banner-en.png` — 2560×800 English horizontal banner
- `banners/edith-banner-tr.png` — 2560×800 Turkish horizontal banner
- `banners/edith-banner-vertical-en.png` — 1280×2560 English vertical banner
