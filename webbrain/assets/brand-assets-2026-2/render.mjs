...
const copy = {
  en: {
    ...
    bannerUrl: 'edith.one',
    socialUrl: 'github.com/edith-one/edith',
  },
  tr: {
      ...
      <main class="canvas paper social-card">
        <div class="social-inner">
          <div class="social-brand">
            ...
            <span class="wordmark">EDITH</span>
          </div>
...
function socialCardSmall() {
  const c = copy.en;
  return {
    file: 'edith-social-card-300x188.png',
    width: 300,
    height: 188,
    body: `
...
function banner(locale) {
  ...
  return {
    file: `banners/edith-banner-${locale}.png`,
    width: 2560,
    height: 800,
    body: `
      <main class="canvas paper banner-wide ${isTurkish ? 'banner-tr' : 'banner-en'}">
        <section class="banner-brand">
          <img class="logo" src="${assets.logo}" alt="">
          <div class="banner-wordmark wordmark">EDITH</div>
          <div class="url">${c.bannerUrl}</div>
        </section>
...
function bannerVertical() {
  const c = copy.en;
  return {
    file: 'banners/edith-banner-vertical-en.png',
    width: 1280,
    height: 2560,
    body: `
