...
No product icon and no "EDITH" corner wordmark on any slide. The hero keeps a small
mono "EDITH" kicker as the only brand mark.
...
The mock agent panel on 02 still reads "EDITH is acting" — depicted product UI, not
slide branding.
...
- 06-launch-offer.png: EDITH Compass $5/mo (reg. $8), Save 35%
