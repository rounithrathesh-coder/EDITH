...
EDITH runs a Discord server as the informal home for users, contributors, and
maintainers to discuss everything EDITH: how to use it, which models and
...
[GitHub](https://github.com/edith-one/edith) so they stay tracked and
...
| `#general`         | Anything EDITH: questions, ideas, conversation                       |
| `#introductions`   | Say hi, tell us what you use EDITH for                               |
...
| `#off-topic`       | Non-EDITH conversation, clearly marked safe space for casual chat    |
...
2. No spam, self-promotion, or unsolicited DMs. The only exception is show-and-tell
   of your own EDITH workflows in `#show-and-tell`.
...
| You want to...                | Where                                                             |
| ----------------------------- | ----------------------------------------------------------------- |
| Get quick help using EDITH | Discord `#help`, `#local-models`, `#providers`                    |
...
| Chat about EDITH casually  | Discord `#general`                                                |
