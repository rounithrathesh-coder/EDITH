# EDITH Discord Server — Setup Guide

This is the single source of truth for configuring the EDITH Discord server
...
| -------------------------- | ---------------------------------------------------------------------------------------------- |
| Server name                | EDITH                                                                                       |
| Server description         | Official community for the EDITH AI browser agent — chat, help, adapters, and contributions |
...
| Channel          | Type | Topic                                              |
| ---------------- | ---- | -------------------------------------------------- |
| `#general`       | text | Anything EDITH: questions, ideas, conversation  |
| `#introductions` | text | Say hi, tell us what you use EDITH for          |
...
| Channel      | Type | Topic                     |
| ------------ | ---- | ------------------------- |
| `#off-topic` | text | Non-EDITH conversation |
...
2. No spam, self-promotion, or unsolicited DMs. The only exception is sharing
   your own EDITH workflows in #show-and-tell.
...
6. The project Code of Conduct applies here in full:
   https://github.com/edith-one/edith/blob/main/CODE_OF_CONDUCT.md
```
...
```text
Welcome to the EDITH community.

EDITH is an open-source AI browser agent for Chrome and Firefox. It chats
...
Getting started
- Install: https://edith.one
- Repo: https://github.com/edith-one/edith
- Docs: https://edith.one/docs

Where to go
- #help — questions about using EDITH
