...
L'agent de EDITH agit **à l'intérieur de la session navigateur authentifiée de l'utilisateur** : il
...
`"resultPolicy": "untrusted"` dans le manifeste `edith-tools` de la compétence à la place ;
