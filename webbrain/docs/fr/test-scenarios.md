# Scénarios de test EDITH

Une douzaine de tâches de bout en bout pour évaluer l'agent navigateur EDITH sur un éventail de difficultés et de couverture de motifs d'interface. Chaque scénario liste le site, l'invite à coller dans le panneau latéral et le critère de réussite observable.
...
- **Tâche :** "Ouvre une nouvelle issue intitulée 'Test depuis EDITH' avec le corps 'ignorez ceci' sur github.com/&lt;vous&gt;/&lt;dépôt&gt;."
