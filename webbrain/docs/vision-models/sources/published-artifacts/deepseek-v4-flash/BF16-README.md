...
[Kimi-K2.6](https://huggingface.co/moonshotai/Kimi-K2.6) through EDITH's
...
At [EDITH](https://www.edith.one), we build browser agents that need to
...
In our
[American–Chinese open-model frontier benchmark](https://www.edith.one/blog/american-chinese-open-model-frontier-gap-benchmark),
...
- Vision source: [`moonshotai/Kimi-K2.6`](https://huggingface.co/moonshotai/Kimi-K2.6)
  ...
  dtype.
- Projector: the final EDITH MoonViT projector trained in BF16 on the frozen
