...
const DEFAULT_SITE_ORIGIN = 'https://edith.one';
...
Options:
  ...
  --site <origin>  Site origin for canonical URLs (default: https://edith.one)
...
async function buildPost(filePath, args) {
  ...
  return {
    ...
    bodyHtml,
    urlPath: `/blog/${slug}`,
    titleTag: String(meta.titleTag || meta.title_tag || `${title} - EDITH Blog`),
  ...
  return `<style>
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media (max-width: 420px) {
      .nav-inner { gap: 12px; }
      .nav-links a[href="https://github.com/edith-one/edith"] { display: none; }
...
function themeBootstrapScript() {
  return `<script>
    (function () {
      try {
        var saved = localStorage.getItem('edith-theme');
  ...
  return `<script>
    (function () {
      ...
      function setTheme(theme, persist) {
        ...
        if (persist) {
          try { localStorage.setItem('edith-theme', theme); } catch (_) {}
        }
      }
      ...
      function onMQ(e) {
        try {
          if (localStorage.getItem('edith-theme')) return;
        } catch (_) {}
...
function navHtml() {
  ...
  return `<nav>
    <div class="nav-inner">
      <a href="/" class="nav-brand"><img class="brand-logo" src="/logo-github.png" alt="" aria-hidden="true"> EDITH<span class="domain">.one</span></a>
      <div class="nav-links">
        <a href="/">Home</a>
        <a href="/docs/">Docs</a>
        ...
        <a href="https://github.com/edith-one/edith" target="_blank" rel="noopener">GitHub</a>
      </div>
    </div>
  </nav>`;
}
...
function sharedHead({ title, description, canonical, ogType = 'website', ogTitle, ogDescription, twitterTitle, twitterDescription, keywords, jsonLd, extraHead = '' }, site) {
  ...
  <meta property="og:image:alt" content="EDITH — Open-source AI browser agent">
  ...
  <meta name="twitter:image:alt" content="EDITH — Open-source AI browser agent">
...
${post.bodyHtml}
    ...
    <div class="author-box">
      Written by <a href="${escAttr(post.authorUrl)}" target="_blank" rel="noopener">${escHtml(post.author)}</a>. EDITH 33.0.0 and later is GPL-3.0-or-later and open on <a href="https://github.com/edith-one/edith" target="_blank" rel="noopener">GitHub</a>.
    </div>
  </article>
...
function renderIndexPage(posts, args) {
  ...
  const socialImageUrl = `${args.site}${SOCIAL_IMAGE_PATH}`;
  const description = 'Engineering notes from EDITH - the open-source AI browser agent.';
...
${sharedHead({
    ...
    twitterTitle: 'EDITH Blog',
    twitterDescription: 'Engineering notes from EDITH.',
    jsonLd,
...
<body class="blog-index">
  ...
  <main>
    <h1 class="sr-only">EDITH Blog</h1>
...
function footerHtml() {
  return `<footer>
    <div>&copy; 2026 EDITH &middot; <a href="/privacy">Privacy</a></div>
    <div><a href="https://github.com/edith-one/edith" target="_blank" rel="noopener">GitHub</a></div>
  </footer>`;
}
