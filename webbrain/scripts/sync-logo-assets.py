#!/usr/bin/env python3
"""Regenerate every EDITH logo derivative from the canonical brand assets.
...
COMPOSITE_LOGOS = (
    (ASSETS / "banners" / "edith-banner-en.png", (140, 228, 396, 484), 48),
    (ASSETS / "banners" / "edith-banner-tr.png", (140, 228, 396, 484), 48),
    (ASSETS / "banners" / "edith-banner-vertical-en.png", (472, 456, 808, 792), 64),
    (ASSETS / "edith-social-card-300x188.png", (91, 25, 126, 60), 8),
    (ASSETS / "edith-social-card.png", (436, 84, 556, 204), 26),
    (WEB / "assets" / "edith-ollama-heart.png", (202, 175, 460, 433), 30),
)
...
def main() -> None:
    ...
    print("Synchronized EDITH logo assets from assets/logo-github.png")
