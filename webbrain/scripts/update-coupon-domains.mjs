...
const SOURCE_DEFINITIONS = Object.freeze({
  ...
  vetted: Object.freeze({
    url: 'https://github.com/edith-one/edith/blob/main/scripts/update-coupon-domains.mjs',
    ...
    try {
      response = await fetchImpl(url, {
        headers: {
          ...
          'user-agent': 'EDITHCouponDomainUpdater/2.0 (+https://github.com/edith-one/edith)',
        },
        redirect: 'follow',
