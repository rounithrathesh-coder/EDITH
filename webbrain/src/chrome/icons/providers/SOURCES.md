...
(`@lobehub/icons-static-svg`, MIT). Filenames match EDITH provider ids.
...
| local_openai_proxy, webgpu | EDITH-authored generic local-runtime marks |
...
| edith_cloud | EDITH extension icon |
