...
const EMERGENCY_BOX_DB_NAME = 'edith_emergency_box';
const EMERGENCY_BOX_DB_VERSION = 1;
const RESOURCE_STORE = 'resources';
const RESOURCE_DIRECTORY = 'edith-emergency-box';
...
export async function withEmergencyResourceLock(resourceId, task, options = {}) {
  ...
  const lockName = `edith-emergency-pdf:${safeResourceKey(resourceId)}`;
