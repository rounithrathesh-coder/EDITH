...
export const EMERGENCY_CORPUS_DB_NAME = 'edith_offline_rag';
export const EMERGENCY_CORPUS_DB_VERSION = 1;
export const EMERGENCY_CORPUS_STORE = 'corpora';
export const EMERGENCY_CORPUS_DIRECTORY = 'edith-offline-rag';
...
export async function withEmergencyCorpusLock(task, options = {}) {
  ...
  return await lockManager.request('edith-emergency-corpus', lockOptions, async (lock) => {
