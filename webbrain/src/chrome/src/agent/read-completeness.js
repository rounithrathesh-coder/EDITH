...
export function readCompletenessLimitation(state, mode = 'ask') {
  ...
  return 'I could not verify the complete Gmail conversation because one or more messages may still be collapsed, and Ask mode cannot expand them. Expand all messages in Gmail and retry, or switch to Act mode so EDITH can expand the conversation before reading it.';
}
