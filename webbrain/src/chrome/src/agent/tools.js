...
/**
 * Strict-mode replacement for the `done` tool. This is edith running as a
...
- set_field: One-shot focus + clear + type + verify on a text field by ref_id.
...
- Examples of the rule:
  ...
  - "What's in the README of edith-one/edith?" → fetch_url the raw GitHub URL. Reading is fine.
