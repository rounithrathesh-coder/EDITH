 ...
 *
 * Provider selection
 *   The Whisper API isn't a separate first-class provider in edith's
      ...
      return {
        ...
        error:
          ...
          (isLocal
            ...
            : `Add an API key for OpenAI (whisper-1) or Groq (whisper-large-v3) in Settings → Providers — edith auto-picks the first ` +
