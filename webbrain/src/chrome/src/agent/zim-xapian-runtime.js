 ...
 * index check therefore comes from EDITH's own ZIM reader, passed in here,
 ...
 * @param options.hasFullTextIndex  (record) => Promise<boolean>, answered by EDITH's reader.
 */
