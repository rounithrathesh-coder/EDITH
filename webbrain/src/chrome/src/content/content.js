...
(() => {
  ...
  const SET_CHECKED_MARKER_ATTRIBUTE = 'data-edith-set-checked-target';
  ...
  const DEV_TARGET_MARKER_ATTR = 'data-edith-dev-target';
  ...
  function highlightDevElement(params) {
    ...
    overlay.setAttribute('data-edith-dev-highlight', '');
