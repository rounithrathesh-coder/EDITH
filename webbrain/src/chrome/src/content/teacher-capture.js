...
(() => {
  if (window.top !== window || window.__edithTeacherCaptureInstalled) return;
  window.__edithTeacherCaptureInstalled = true;

  const INDICATOR_ID = 'edith-teacher-indicator';
  ...
  function updateIndicator() {
    ...
    indicator.textContent = `● EDITH Teach${sessionName ? ` · ${sessionName}` : ''}`;
