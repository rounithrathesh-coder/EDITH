...
export default {
  ...
  'st.display.research_escalation.desc': 'When enabled, EDITH may ask before sending an unusually complex read-only research prompt to ChatGPT. Off by default. The exact prompt is shared only after your explicit approval.',
  ...
  'brand': 'EDITH',
  'install.page_title': 'EDITH installed',
  'install.installed': 'EDITH installed',
  'install.checking': 'Checking your browser…',
  'install.ready': 'Ready',
  'install.extensions': 'Extensions',
  'install.eyebrow': 'One small setup step',
  'install.title': 'Keep EDITH one click away',
  'install.intro': 'Your browser may hide newly installed extensions. Keep EDITH visible so it stays easy to open.',
  ...
  'install.keep_visible.title': 'Keep EDITH visible',
  'install.keep_visible.body': 'Find EDITH and choose the pin, show, or keep-in-toolbar option.',
  'install.open.title': 'Open it from any page',
  'install.open.body': 'Select the EDITH icon',
  ...
  'install.open_panel.body': 'Open EDITH next to this page to finish setup.',
  'install.pin.title': 'Pin EDITH to your toolbar',
  'install.pin.body': 'Click the pin in the side panel header above. This adds EDITH to your browser toolbar for one-click access.',
  'install.pin.next': 'After the side panel opens, use the pin in its header to add EDITH to your browser toolbar.',
  'install.pin.confirm': 'I pinned it',
  'install.pin.skip': 'Skip this step',
  'install.firefox_pin.body': 'To keep EDITH handy, open Firefox Extensions, select the gear beside EDITH, then choose Pin to Toolbar.',
  'install.open_failed_chromium': 'The side panel did not open. Press Alt+Shift+W, or open your browser’s Extensions menu and select EDITH.',
  'install.open_failed_firefox': 'The sidebar did not open. Open Firefox Extensions and select EDITH.',
  ...
  'sp.record.full_screen_started_html': 'Screen/window recording started. Stop it with <strong>Stop</strong> on the recording banner, by pressing <code>Escape</code> twice in EDITH or a browser page, or with Chrome\'s Stop sharing control. Add <code>--hide-recording-indicator</code> to keep the banner out of the video.',
  'sp.record.full_screen_started_hidden_html': 'Screen/window recording started. Press <code>Escape</code> twice in EDITH or a browser page to stop, or use Chrome\'s Stop sharing control.',
  ...
  'sp.mic.permission_denied': 'Microphone blocked — right-click the EDITH icon in the toolbar → Manage extension → Site settings → set Microphone to Allow',
  ...
  'sp.inspection': 'EDITH started inspecting this page',

  'sp.greeting.html': 'Hi! I\'m <strong>EDITH</strong>. I can read this page, answer questions, click buttons, fill forms, and automate multi-step tasks.',
  ...
  "sp.workflows.standalone_unavailable": "This standalone window is Ask-only. Open EDITH in the side panel to run saved workflows in Act mode.",
  ...
  'sp.recommended.tweet.label': 'Tweet about EDITH',
  ...
  'sp.recommended.tweet.text': 'Introducing EDITH — an open-source AI browser agent that lives in your browser. Chat with any page, automate multi-step workflows, and bring your own LLM. Extensible by design. Try it: https://edith.one',
  'sp.recommended.linkedin.label': 'Post about EDITH',
  ...
  'sp.review.rating_title': 'Enjoying EDITH?',
  'sp.review.rating_body': 'Tap a star — it helps us know how we\'re doing.',
  'sp.review.stars_label': 'Rate EDITH',
  ...
  'sp.review.positive_body': 'Would you leave a quick review on the extension store? It helps others discover EDITH.',
  ...
  'sp.schedule_form.prompt_placeholder': 'What should EDITH do when this runs?',
  ...
  'sp.subscribe.allowance_used': 'Daily free EDITH Compass allowance used.',
  ...
  'sp.perm.question': 'EDITH wants to {verb} {host}. Allow it?',
  'sp.perm.reason': 'Permission check — EDITH only takes consequential actions on sites you allow.',
  'sp.perm.allow_once': 'Allow once',
  'sp.perm.always_allow': 'Always allow on {host}',
  'sp.perm.dont_allow': "Don't allow",
  'sp.perm.skip_hint': 'Want fewer interruptions? “Always allow” remembers this site. The command below disables EDITH permission prompts on every site.',
  ...
  'sp.permissions.disabled_html': '⚠️ <strong>Permission prompts are OFF.</strong> EDITH will click, type, navigate, run JavaScript, upload, download, record, and schedule future work without asking first. Re-enable this from Settings → Permissions → Ask before consequential actions.',
  ...
  'sp.slash.busy_only_oob': 'Messages are queued while EDITH is busy. Only /help, /progress, /scratchpad, /memory, /schedule --list, /watch, /dangerously-skip-permissions, /screenshot, /export, /export --traces, and /verbose can run immediately as slash commands.',
  ...
  'ob.welcome.title': 'Welcome to EDITH',
  'ob.welcome.body': 'EDITH is an AI browser agent that lives in your sidebar. It can read pages, answer questions, fill forms, click buttons, and automate multi-step tasks across the web.',
  'ob.welcome.note': 'Let\'s walk through a couple of things before you get started.',
  'ob.act.title': 'Review before Act mode',
  'ob.act.body': 'EDITH Act mode can take real actions on your behalf. You are responsible for reviewing prompts, destinations, and outcomes before continuing.',
  'ob.act.warn1': 'EDITH may capture screenshots for planning. Avoid using agent mode on sensitive pages, such as health, finance, dating, or private account portals, unless you accept that risk.',
  ...
  'ob.tokens.body': 'EDITH needs a language model to work. We will check for local models first. If none are available, open Settings and add a provider:',
  'ob.tokens.scanning': 'Checking for local models...',
  'ob.tokens.local_body': 'A local model is available on this computer. Pick one to enable it and start using EDITH now.',
  'ob.tokens.local_models_label': 'Local model',
  'ob.tokens.context_hint': 'For reliable agent runs, pick a model with at least a 16k-token context window. 8k can work with Compact mode enabled; 4k is too small for the tool set. EDITH auto-compacts the conversation as it approaches the window.',
  ...
  'ob.tokens.option_lmstudio': 'LM Studio - run models locally for free. Start LM Studio, load a model, and EDITH connects automatically.',
  ...
  'ob.btn.start': 'Start',
  'ob.cloud.body': 'EDITH Compass is ready with a free daily allowance. Selected Compass conversations may be retained and used to improve EDITH while Help Improve EDITH is on by default. You can turn it off in Settings → General.',
  'ob.cloud.change': 'Change',
  'ob.cloud.using': 'Using EDITH Compass. ',

  // --- Settings ----------------------------------------------------------
  'st.title': 'EDITH Settings',
  ...
  'st.perms.gate.desc': 'Recommended. When on, EDITH asks permission the first time it clicks, types, navigates, runs JavaScript, uploads, downloads, records, or schedules future work on a site (then remembers your choice). Turn off for fast, prompt-free use on sites you fully trust.',
  'st.perms.gate.warning': '⚠️ Permission prompts are OFF. EDITH will click, type, navigate, run JavaScript, upload, download, record, and schedule future work on any site WITHOUT asking — including on pages whose content may be attacker-controlled. Page content is still treated as untrusted internally, but nothing will stop an injected instruction from triggering an action. Only leave this off if you fully trust every site you use the assistant on.',
  'st.perms.desc': 'Sites you have allowed EDITH to act on. Each entry is one capability (click, type, navigate, run JavaScript, etc.) granted to a specific site. Remove any you no longer want — EDITH will ask again next time it needs it.',
  'st.perms.empty': 'No site permissions granted yet. EDITH asks before it clicks, types, navigates, uploads, downloads, records, schedules future work, or runs code on a site, and remembers your choice here when you pick “Always allow”.',
  ...
  'st.display.language.desc': 'Interface language for the EDITH plugin.',
  ...
  'st.display.download_directory.error': 'Use a relative folder such as EDITH or Work/EDITH. Absolute paths and “..” are not allowed.',
  ...
  'st.display.help_improve.label': 'Help Improve EDITH',
  'st.display.help_improve.desc_html': 'Allow eligible EDITH Compass text and tool interactions to be retained and used for evaluation, improvement, fine-tuning, and training. On by default. Turning this off permanently opts out the current conversation; turning it back on applies to the next new conversation. Screenshots and image bytes are not retained in the EDITH improvement database. <u>Local-model and bring-your-own API requests are never collected by EDITH.</u> <a href="https://edith.one/privacy" target="_blank" rel="noopener noreferrer" style="color:var(--accent);">Privacy policy →</a>',
  ...
  'st.display.selection_shortcut.desc': 'Show a EDITH button when you select text on a page. The native right-click action remains available when this is off.',
  'st.display.auto_group_tabs.label': 'Group EDITH tabs',
  'st.display.auto_group_tabs.desc': 'Automatically place tabs opened from the toolbar, context menu, or by the agent in a named EDITH browser tab group. Turning this off does not change existing groups.',
  ...
  'st.display.always_allow_api_mutations.desc': "Allow EDITH to use POST, PUT, PATCH, and DELETE through fetch_url or research_url without requiring /allow-api in each conversation. UI-first guidance and confirmation checks still apply. Off by default.",
  'st.display.api_mutation_observer.label': 'API mutation observer',
  'st.display.api_mutation_observer.desc': 'Observe same-tab XHR/fetch request URLs and methods so EDITH can detect repeated UI actions and suggest API shortcut patterns. Off by default; enable only while investigating shortcut behavior or latency.',
  'st.display.webmcp.label': 'Experimental WebMCP',
  'st.display.webmcp.desc': 'Allow EDITH to discover and run structured tools exposed by supported Chrome pages. Enabling this adds experimental WebMCP tools and guidance to the model context. Off by default.',
  ...
  'st.display.scheduled_tasks.desc': 'Allow EDITH to resume deferred work and run one-shot or recurring scheduled tasks using browser alarms. On by default.',
  ...
  'st.providers.ollama_warning.body': 'Recent Ollama versions can reject requests from browser-extension origins even when Ollama is running on the same machine. EDITH sends a chrome-extension://… or moz-extension://… Origin, and Ollama may return 403 unless those origins are allowed.',
  ...
  'st.providers.ollama_warning.base_url': 'Keep EDITH’s Ollama base URL set to http://localhost:11434/v1. Terminal curl checks can still work without this setting because they do not send a browser-extension origin.',
  ...
  'st.providers.compat.extra_body_help': 'Merged after the preset. Per-call EDITH overrides still win. Model, messages, tools, stream, and token-limit fields are protected.',
  ...
  'st.providers.edith_data_use.body': 'Free daily EDITH Compass usage is included. While Help Improve EDITH is on by default, selected Compass conversations may be retained and used for evaluation, improvement, fine-tuning, and training. Turn it off in General → Advanced to exclude future Compass interactions from those uses. <u>Local-model and bring-your-own API requests are never collected by EDITH.</u> {privacyLink}. For more usage, subscribe at {subscribeLink}. Manage billing at {accountLink}.',
  'st.providers.edith_note.body': 'Free daily EDITH Compass usage is included. Requests go through api.edith.one; by default we log metadata for quota and debugging, not prompt text, page content, screenshots, or model responses. {privacyLink}. For more usage, subscribe at {subscribeLink}. Manage billing at {accountLink}.',
  'st.providers.edith_note.privacy_link': 'Privacy policy',

  'st.skills.desc_html': 'Enabled skills are available on demand in Mid and Full tiers; Compact does not load skills. A small catalog sends only each eligible skill\'s ID, name, summary, and optional semantic intents. The planner can select relevant skills from this routing metadata; full instructions and compatible <code>edith-tools</code> are exposed only after activation for the current run. Optional <code>edith-skill</code> metadata controls the summary, semantic intents, and Ask/Act compatibility.',
  ...
  'st.vision.local.title': 'EDITH VL 2 450M local fallback',
  "st.vision.local.desc": "Runs edith-one/edith-vl-2-450M-onnx on your GPU. Screenshots stay on this device. Selecting “Use local fallback” checks WebGPU, records your consent, and starts an approximately 810 MB background download from Hugging Face. Tasks report its status and never wait for it; keep Chrome open.",
  ...
  'st.memory.auto.desc': 'When on, EDITH makes a best-effort background LLM call after completed turns to extract durable preferences. It never blocks the active reply.',
  ...
  'st.memory.import.placeholder': 'Paste exported EDITH user memory JSON here...',
  ...
  "sp.slash.import_config": "Import a EDITH configuration JSON snapshot",
  "sp.slash.import_config_file": "Choose a EDITH configuration JSON file",
  ...
  'st.sync.lede_html': '<strong>EDITH Compass members only.</strong> Sync memories, profile autofill, and API-key provider settings across devices. Everything is encrypted with your sync password before upload. EDITH cannot read or recover it. Chat history and OAuth sign-ins are not synced.',
  'st.sync.email.label': 'EDITH Compass email',
  ...
  'st.sync.status.subscription': 'EDITH Compass membership is required for encrypted sync.',
  'st.sync.status.error': 'Encrypted sync needs attention.',
  'st.sync.status.auth_required': 'Sign in with your EDITH Compass email to use encrypted sync.',
  ...
  'st.sync.validation.email_required': 'Enter your EDITH Compass billing email.',
  ...
  'st.sync.auth.check_email': 'Check your email, approve the EDITH Compass sign-in link, then return here.',
  ...
  'st.sync.confirm.reset': 'Replace the encrypted cloud copy with this device’s current EDITH setup?',
  'st.sync.consent.legacy': 'Turn on encrypted sync? EDITH will transmit an end-to-end encrypted copy of your memories, profile autofill, and API-key provider settings to EDITH Compass. Chat history and OAuth sign-ins are not synced.',
