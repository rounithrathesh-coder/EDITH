...
const CLOUD_BRIDGE_ENABLED_KEY = 'edithCloudBridgeEnabled';
const CLOUD_BRIDGE_URL_KEY = 'edithCloudBridgeUrl';
...
helpImproveToggle?.addEventListener('change', async () => {
  await chrome.storage.local.set({ helpImproveEDITH: helpImproveToggle.checked }).catch(() => {});
});
