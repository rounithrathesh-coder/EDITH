...
export const STORE_URLS = {
  chrome: 'https://chromewebstore.google.com/detail/edith/ljhijonmfahplgbbacgcfnaihbjljhhb',
  firefox: 'https://addons.mozilla.org/en-US/firefox/addon/edith/',
};

export const FEEDBACK_ISSUES_URL = 'https://github.com/edith-one/edith/issues/new';
...
export function buildFeedbackUrl({ rating, comment = '' } = {}) {
  const title = encodeURIComponent(`EDITH feedback (${rating}/5)`);
  const bodyParts = [
    `**Rating:** ${rating}/5`,
    '',
    ...
    '',
    '---',
    '_Submitted from the EDITH side panel feedback prompt._',
  ];
