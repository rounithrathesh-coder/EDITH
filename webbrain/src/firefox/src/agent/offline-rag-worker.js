...
const SQLITE_POOL_DIRECTORY = '.edith-offline-rag-sahpool-v1';
const SQLITE_POOL_NAME = 'edith-offline-rag-sahpool-v1';
...
function databaseFilename(indexPath) {
  return `/edith-${validateOfflineRagIndexPath(indexPath).slice('sqlite/'.length)}`;
}
