/**
 * Deterministic capability × origin permission gate for the EDITH agent.
 *
...
// Human-readable verb for the permission prompt: "EDITH wants to <label> <host>".
...
const TOOL_CAPABILITY = {
  ...
  click_coordinate: Capability.CLICK,
  ...
  type_coordinate: Capability.TYPE,
