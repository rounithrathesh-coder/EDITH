...
export const DEFAULT_CONFIG_SETTINGS = Object.freeze({
  ...
  [AUTO_GROUP_TABS_KEY]: false,
  helpImproveEDITH: true,
...
export function createConfigExport(stored = {}, options = {}) {
  ...
  return {
    ...
    edithVersion: String(options.edithVersion || 'unknown'),
...
export function parseConfigImport(json) {
  ...
  return {
    ...
    sourceVersion: typeof parsed.edithVersion === 'string' ? parsed.edithVersion : '',
  };
}
...
export function mergeConfigPatchSettings(current = {}, patch = {}) {
  ...
  // replace the runtime's current EDITH Compass configuration.
  delete patchProviders.edith_cloud;
