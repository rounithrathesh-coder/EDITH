 ...
 */
(() => {
  const PROBE_EVENT = 'edith:file-picker-guard-probe';
  const PROBE_ATTR = 'data-edith-file-picker-probe';
  const PROBE_ACK_ATTR = 'data-edith-file-picker-probe-ack';
  const ARM_EVENT = 'edith:file-picker-guard-arm';
  const DISARM_EVENT = 'edith:file-picker-guard-disarm';
  const RESET_EVENT = 'edith:file-picker-guard-reset';
  const BLOCKED_EVENT = 'edith:file-picker-guard-blocked';
  const GUARD_ATTR = 'data-edith-file-picker-guard';
  const BLOCKED_ATTR = 'data-edith-file-picker-blocked';
