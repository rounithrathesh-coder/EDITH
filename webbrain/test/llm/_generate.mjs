...
const githubRepo = { url: 'https://github.com/esokullu/edith', title: 'esokullu/edith — GitHub' };
const githubLogin = { url: 'https://github.com/login', title: 'Sign in to GitHub' };
const ghDist = { url: 'https://github.com/esokullu/edith/tree/main/dist', title: 'edith/dist — main' };
...
const ghIssues = { url: 'https://github.com/esokullu/edith/issues', title: 'Issues · esokullu/edith' };
const ghReleases = { url: 'https://github.com/esokullu/edith/releases', title: 'Releases · esokullu/edith' };
const ghPr = { url: 'https://github.com/esokullu/edith/pulls', title: 'Pull requests · esokullu/edith' };
...
const CASES = [
  ...
  },
  {
    ...
    tab: { url: 'https://github.com/esokullu/edith/releases/new', title: 'New Release' },
    ideal: verify(),
  ...
  // ── GitHub (42-47) ─────────────────────────────────────────────────
  {
    ...
    tab: githubRepo,
    ideal: nav('https://github.com/esokullu/edith/releases/new'),
  ...
  },
  {
    ...
    tab: githubRepo,
    ideal: nav('https://github.com/esokullu/edith/compare'),
  ...
  },
  {
    ...
    tab: githubRepo,
    ideal: nav('https://github.com/esokullu/edith/issues/new'),
  ...
  },
  {
    ...
    tab: githubRepo,
    ideal: download('https://raw.githubusercontent.com/esokullu/edith/main/README.md'),
  ...
  },
  {
    ...
    tab: HOME,
    ideal: done('I can\'t close tabs from here — EDITH doesn\'t have a tabs-close tool. You can do this manually with right-click on a tab → "Close other tabs".'),
