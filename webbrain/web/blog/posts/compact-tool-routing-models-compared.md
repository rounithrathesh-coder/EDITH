...
readTime: 3 min read
description: >
  An updated EDITH Compact benchmark table comparing Compass Tiny with Gemma 4, Qwen 3.5, Qwen 3.6, Qwen 3.8, Nanbeige, and the LFM2.5 base model.
excerpt: >
...
titleTag: >
  Compact Tool Routing: 10 Models Compared - EDITH Blog
ogTitle: >
  Compact tool routing: 10 models compared
ogDescription: >
  The latest EDITH Compact routing results for Compass Tiny, Gemma 4, Qwen, Nanbeige, and LFM2.5.
twitterTitle: >
  Compact tool routing: the updated EDITH table
twitterDescription: >
...
| **EDITH Compass Tiny v1** | **2.6B** | 81 / 100 | 4 | 42 | 47.2% |
...
Tags: #EDITH #BrowserAgent #ToolCalling #CompactMode #Gemma4 #Qwen #CompassTiny
