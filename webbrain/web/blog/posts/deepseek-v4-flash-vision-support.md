...
readTime: 2 min read
description: >
  EDITH's DeepSeek V4 Flash Vision NVFP4 release adds screenshot and interface understanding to a model that was previously text-only.
excerpt: >
...
titleTag: >
  DeepSeek V4 Flash now has vision support - EDITH Blog
ogTitle: >
  DeepSeek V4 Flash now has vision support
ogDescription: >
  EDITH's new DeepSeek V4 Flash Vision NVFP4 release gives the efficient open model the visual context browser agents need.
twitterTitle: >
  DeepSeek V4 Flash now has vision support
twitterDescription: >
  Screenshots, interfaces, layouts, and visual browser context are now supported in EDITH's DeepSeek V4 Flash Vision NVFP4 release.
keywords:
  - EDITH
  - DeepSeek V4 Flash
...
[edith-one/DeepSeek-V4-Flash-Vision-NVFP4](https://huggingface.co/edith-one/DeepSeek-V4-Flash-Vision-NVFP4)
