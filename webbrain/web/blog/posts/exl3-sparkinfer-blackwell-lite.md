...
titleTag: >
  EXL3: Best Quantization for Local AI on Blackwell Lite — EDITH Blog
ogTitle: >
  EXL3 is the best quantization schema for local AI right now
ogDescription: >
...
| [Laguna-XS-2.1-exl3](https://huggingface.co/turboderp/Laguna-XS-2.1-exl3) | The small thinking model done right — what we run on EDITH's local path for cheap agentic tasks. |
