---
title: >
  Five things you shouldn't do with EDITH
slug: five-things-you-shouldnt-do-with-edith
sortOrder: -10
date: 2026-07-07
readTime: 3 min read
description: >
  A short pause from EDITH's LLM benchmark posts: five things a browser agent can technically help with, but absolutely should not be used for.
excerpt: >
  We briefly interrupt the benchmark series for a video-sized warning label: EDITH can automate a browser, but consent, legality, and basic human decency still apply.
titleTag: >
  Five things you shouldn't do with EDITH - EDITH Blog
ogTitle: >
  Five things you shouldn't do with EDITH
ogDescription: >
  A short, funny warning-label post about five bad ideas for browser automation, based on the EDITH video.
twitterTitle: >
  Five things you shouldn't do with EDITH
twitterDescription: >
  A video-sized warning label for browser agents: technically possible is not the same as acceptable.
keywords:
  - EDITH
  - browser agent
  - AI automation
...
So this is a short pause for the video below: **Five Things You Shouldn't Do with EDITH!** It is a comedy warning label for a very real truth. EDITH can read pages, compare information, click buttons, fill forms, and help you move around the web faster. That power is useful. It is also not a permission slip.

<div class="video-embed" style="position:relative;width:100%;aspect-ratio:16/9;margin:28px 0;border-radius:12px;overflow:hidden;border:1px solid var(--border);background:var(--code-bg);box-shadow:0 18px 60px var(--shadow-strong);">
  <iframe src="https://www.youtube.com/embed/80IHXb_k01I" title="Five Things You Shouldn't Do with EDITH!" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:0;"></iframe>
</div>
...
EDITH can help draft emails, summarize conversations, and fill forms. That does not mean it should become a polite-looking machine for mass DMs, fake reviews, astroturf comments, referral stuffing, or "personalized outreach" that is only personalized because the first name field worked.
...
If you are logged into something, EDITH can often help you understand what is on the page. That is great when it is your dashboard, your inbox, your bill, your admin panel, or a document you are allowed to handle.
...
EDITH is much better as a calm assistant than as a tiny accomplice in a trench coat. And yes, the trench coat is also against the terms.

## 5. The "the AI clicked it" alibi

This is the big one. EDITH can help you click, type, navigate, and submit. But the browser is still yours. The account is still yours. The action is still yours.
...
Use EDITH for the good boring stuff: reading pages, comparing options, checking your own accounts, drafting your own messages, organizing research, and automating workflows where you have permission to be.
