...
description: >
  We ran the same frozen EDITH UI-vision probe against Thinking Machines Inkling Small on OpenRouter and a full GLM-5.2 Vision hybrid on four RTX PRO 6000 Blackwell GPUs at RunPod.
excerpt: >
...
titleTag: >
  Inkling Small vs GLM-5.2 Vision UI benchmark - EDITH Blog
ogTitle: >
...
The final system read every string, interpreted the validation error, and identified the correct blocker on its first frozen EDITH probe. It did this without jointly retraining the enormous language backbone and vision encoder.
...
But neither answer was complete. Both missed the email-chip chevron, and GLM also missed the red border and focus state. This is exactly why EDITH's vision prompt asks for unknowns: a planning agent should know when a visual interpretation is uncertain.
...
- [Inkling Small result](https://github.com/edith-one/edith/blob/main/test/vision-results/2026-08-02-inkling-small-openrouter.json)
- [Inkling Small evaluation](https://github.com/edith-one/edith/blob/main/test/vision-results/2026-08-02-inkling-small-openrouter-evaluation.json)
- [GLM-5.2 Vision result](https://github.com/edith-one/edith/blob/main/test/vision-results/2026-08-02-glm-5-2-vision-runpod-hybrid.json)
- [GLM-5.2 Vision evaluation](https://github.com/edith-one/edith/blob/main/test/vision-results/2026-08-02-glm-5-2-vision-runpod-hybrid-evaluation.json)
- [GLM-5.2 Vision deployment record](https://github.com/edith-one/edith/blob/main/test/vision-results/2026-08-02-glm-5-2-vision-runpod-hybrid-deployment.json)
