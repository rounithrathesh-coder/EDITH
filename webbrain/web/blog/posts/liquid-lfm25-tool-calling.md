...
titleTag: >
  Liquid LFM 2.5-8B-A1B on browser tool calling: an on-device MoE meets EDITH — EDITH Blog
ogTitle: >
...
So: LFM 2.5 is an interesting on-device architecture from a lab worth watching, and we will retest the line as it evolves. For EDITH’s small-model slot today, we’re sticking with Gemma 4-E2B.
...
- [github.com/edith-one/edith/tree/main/test/llm/analysis](https://github.com/edith-one/edith/tree/main/test/llm/analysis) — spreadsheets and the per-task HTML matrix
- [freeze/baseline-2026-05-23.json](https://github.com/edith-one/edith/blob/main/test/llm/freeze/baseline-2026-05-23.json) — the snapshot the runner pins to
