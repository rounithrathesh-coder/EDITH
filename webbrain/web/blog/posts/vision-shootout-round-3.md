...
titleTag: >
  Round 3: Xiaomi MiMo V2.5 enters the vision shootout — and joins the "Unknowns: None" club — EDITH Blog
ogTitle: >
...
The [Pro vs Flash post](/blog/mimo-v25-pro-vs-flash) was a research note: vendor benchmarks looked strong, omni-modal positioning matched EDITH's screenshot-heavy loop, the recommendation was to add MiMo behind an opt-in routing flag and let the eval harness decide. Empirically:
...
- **Multilingual screenshots.** MiMo is multilingual on paper; we haven't tested it on Turkish, Spanish, or Chinese pages. Round 2 ruled Nemotron out on this axis without EDITH users seeing a benchmark; MiMo might recover here.
