---
title: >
  Why EDITH 33.0.0 is GPL
slug: why-edith-33-is-gpl
sortOrder: -210
date: 2026-08-20
readTime: 2 min read
description: >
  EDITH 33.0.0 ships under GPL-3.0-or-later because the extension bundles the Xapian/libzim WebAssembly runtime for full-text Wikipedia ZIM search. Releases before 33.0.0 remain MIT.
excerpt: >
...
titleTag: >
  Why EDITH 33.0.0 is GPL - EDITH Blog
ogTitle: >
  Why EDITH 33.0.0 is GPL
ogDescription: >
...
lede: >
  **EDITH 33.0.0 is GPL-3.0-or-later.** Tagged releases before that stay MIT.
---
...
The MCP server and LM Studio plugin remain MIT. Third-party files keep their own notices. Each 33.x release publishes corresponding source for the bundled Wasm. The longer record is in the [licensing decision](https://github.com/edith-one/edith/blob/main/docs/offline-rag-licensing.md).
