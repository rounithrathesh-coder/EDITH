...
readTime: 6 min read
description: >
  Disasters, wars, infrastructure failures, and the unexpected can take the internet away. EDITH's Apocalypse Mode keeps local AI, Wikipedia, and practical references ready in the browser.
excerpt: >
...
titleTag: >
  Why We Built Apocalypse Mode for Offline Access - EDITH Blog
ogTitle: >
  The world needs offline access. That's why we built Apocalypse Mode.
ogDescription: >
...
twitterTitle: >
  Why EDITH built Apocalypse Mode
twitterDescription: >
...
Apocalypse Mode prepares a working local core inside EDITH before you need it:
...
WebGPU is what lets us ship that capability through the browser. It keeps the setup approachable—open EDITH, enable the mode, let the downloads finish—while using on-device acceleration for inference. No cloud token. No API balance. No round trip.
...
Install EDITH. Open Apocalypse Mode. Let the text model, vision model, and Wikipedia archive reach Ready. Choose the books and field references that make sense for your language, region, family, and work. Then test them offline.
...
[Read the complete Apocalypse Mode setup guide](/docs/apocalypse-mode/), then [download EDITH while you can](/#download).

Keep EDITH in your browser. Keep it ready.

Tags: #EDITH #ApocalypseMode #OfflineAI #WebGPU #OfflineAccess #LocalAI #Wikipedia #Preparedness
